...
Предсказание количества проданных единиц товара (`qty`) на основе исторических данных о ценах, промо-акциях и остатках на складе.
...
CatBoostRegressor с функцией потерь MAE. Категориальные признаки: `is_promo`, `nm_id`.
